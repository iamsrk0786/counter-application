...
//     const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=e1c1d8113e8e72b2dbc507308c290e4d`;
//     axios
//       .get(apiUrl)
//       .then((res) => {
...
//         />
//         <button type="submit" className="btn btn-primary" id="btn" onClick={getWeatherData}>
//           Search
//         </button>
...
//                 <h5 className="card-title">Weather Update </h5>
//                 <h3>City: {weatherData.name}</h3>
//                 <h3>Temperature: {((weatherData.main.temp)-273.15).toFixed(2)}</h3>
//               </div>
//             </div>
//           )}
//         </div>
